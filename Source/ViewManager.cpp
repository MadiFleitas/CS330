...
GLFWwindow* ViewManager::CreateDisplayWindow(const char* windowTitle)
{
	...
	// set up mouse movement and scroll callbacks
...
void ViewManager::Mouse_Position_Callback(GLFWwindow* window, double xMousePos, double yMousePos)
{
	...
	// move the 3D camera according to the calculated offsets (orbiting)
 ...
 *  Scroll_Callback()
 *
 *  This method is called when the scroll wheel is used to
 *  zoom in/out or adjust movement speed.
 ***********************************************************/
void ViewManager::Scroll_Callback(GLFWwindow* window, double xOffset, double yOffset)
{
	// Adjust the zoom level of the camera when scrolling the mouse wheel
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	// process camera upward/downward movement (Q/E keys)
