...
private:
	...
	glm::vec3 m_CameraPosition; // Added member variable for camera position
...
public:
	...
	void SetCameraPosition(const glm::vec3& cameraPosition); // New method to set camera position
};
