...
public:
	...
	// scroll callback for adjusting the camera movement speed
	static void Scroll_Callback(GLFWwindow* window, double xOffset, double yOffset);  // <-- Add this declaration
